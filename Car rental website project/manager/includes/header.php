    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img style="width: 150px; height:50px;" src="assets/images/logo2-bg.png" alt="image"/></a> </div>
        </div>
...
echo "Welcome To Syiok Wheel Car Rental";
 } ?>
          </div>
        </div>
      </div>
